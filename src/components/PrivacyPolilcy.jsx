          ...
          <div className="policy-header">
            ...
            <div className="header-content">
              <div className="content">
                <h1>Who are we?</h1>
                <span></span>
                <p>Fly Realty, is a startup based out of Bangalore with a vision to clean up the real estate space and offer trustworthy consulting services to a large audience including builders and individuals.</p>
              </div>
            </div>
          </div>
          <div className="main">
            <div className="section">
              ...
              <p>Our policies and procedures on the collection, use, and disclosure of Your information, when You use the Service, tell You about Your privacy rights and how the law protects You. Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.
</p>
            </div>
            <div className="section">
              <h1>Information We Collect.</h1>
              <p>We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:</p>
            ...
            <div className="section grey-sect">
              <h1>Usage Data</h1>
              <p>
              Usage Data may include information such as Your Device's Internet Protocol address (e.g. IP address), browser type, browser version, the pages of our Service that You visit, and the time and date of Your visit.</p>
              <p>When accessed through a mobile device, We may collect certain information automatically, including, but not limited to, the type of mobile device You use, Your mobile device's unique ID, the IP address of Your mobile device, Your mobile operating system, the type of mobile Internet browser You use. </p>
...
Cookies.</p>
              <p>We utilize Cookies and tracking technologies such as beacons and scripts to enhance and analyze activity on our Service. These may include Browser Cookies, Web Beacons, and similar tools.
</p>
<p>Cookies can be Persistent or Session-based, with essential ones for service functionality, acceptance tracking, and functionality enhancement.</p>
            <p>
            We use both Session and Persistent Cookies for the purposes set out below:
            </p>
            <div className="points">
              <ul>
                <li className="check-item"><i class="fa-regular fa-square-check"></i>Cookies Policy / Notice Acceptance Cookies</li>
            ...
            <div className="points">
              <ul>
                <li className='check-item'><i class="fa-regular fa-square-check"></i>Functionality Cookies</li>
                <li>Type: Persistent Cookies</li>
                <li>Administered by: Us</li>
                <li>Purpose: These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. This cookie are collected to avoid having to re-enter your preferences every time You use the Website.</li>
              </ul>
            </div>
            </div>
            <div className="section">
            ...
            <div className="section grey-sect">
              <h1>Retention and Transfer of your personal data.</h1>
            ...
            <div className="section">
             ...
             <div className="sect">
              ...
              <p>We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new Privacy Policy on this page.However, you are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</p>
             </div>
            </div>
          </div>
          <div className="foot">
